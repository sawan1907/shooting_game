...
EXPLODE_SOUND = pygame.mixer.Sound("./files/explosion.mp3")
BULLET_HIT_SOUND = pygame.mixer.Sound("./files/bullet_hit.mp3")
BULLET_FIRE_SOUND = pygame.mixer.Sound("./files/bullet_fire.mp3")
...
YELLOW_SPACESHIP_IMAGE = pygame.image.load("./files/spaceship_yellow.png")
...
RED_SPACESHIP_IMAGE = pygame.image.load("./files/spaceship_red.png")
...
SPACE = pygame.transform.scale(pygame.image.load("./files/space.png"),(WIDTH,HEIGHT))
